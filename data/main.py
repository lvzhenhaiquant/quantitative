...
if __name__ == '__main__':
    start_date_str = '20201205'  # 过去5年：从2019年12月开始
    end_date_str = '20251205'    # 到2024年12月（今天）


    # 一、github下载最新Tushare基础数据
    # 1 初始化
    # download_tar_path = r'C:\Users\sheny\Downloads\qlib_bin.tar.gz' #手动下载的数据路包路径
    # target_path = r'C:\Users\sheny\qlib\qlib\qlib_data\cn_data'   #解压到的目标的文件夹路径
    # DownloadGithub = DownLoadGithub.DownloadGithub(target_dir=target_path, local_tar_path=download_tar_path)
    # # # 2 下载
    # DownloadGithub.download_from_github()
    ...
    # 四、将数据转为Qlib格式
    # 1 初始化 （配置路径和参数）
    qlib_data_dir_path = "/home/zhenhai1/quantitative/qlib_data/cn_data"  # QLib数据存放目录
    dump_bin_py_path = "/home/zhenhai1/quantitative/venv/lib/python3.10/site-packages/qlib/scripts/dump_bin.py"  # dump_bin.py脚本路径
